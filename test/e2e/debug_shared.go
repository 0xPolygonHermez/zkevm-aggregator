...
import (
	...
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/BridgeA"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/BridgeB"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/BridgeC"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/BridgeD"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/Called"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/Caller"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/ChainCallLevel1"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/ChainCallLevel2"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/ChainCallLevel3"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/ChainCallLevel4"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/Counter"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/Creates"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/Depth"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/ERC20"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/EmitLog"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/Memory"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/OpCallAux"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/contracts/bin/Revert2"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/operations"
	"github.com/0xPolygonHermez/zkevm-aggregator/test/testutils"
...
func saveTraceResultToFile(t *testing.T, name, network string, signedTx *ethTypes.Transaction, trace json.RawMessage, skip bool) {
	...
	const path = "/Users/thiago/github.com/0xPolygonHermez/zkevm-aggregator/dist/%v.json"
