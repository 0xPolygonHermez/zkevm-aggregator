...
// and returns it.
func (p *Prover) WaitRecursiveProof(ctx context.Context, proofID string, getStateRoot bool) (string, common.Hash, error) {
	...
	if getStateRoot {
		log.Debugf("Response from prover to get state root from: %+v", res)
